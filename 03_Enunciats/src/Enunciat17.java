	...
	public static void main(String args[]) throws Exception {
		...
		do { // REPETIR PER CADA GRANGER
			...
			do { // REPETIR MENTRE OPCIO NO ÉS A o B o C o D
				...
				opcioEscollida = teclat.next().toUpperCase();// toUpper --> vol dir que tan se val si es "m" o "M"
			...
			qtatDeGrangers--; // Començo a amb 50 i vaig decrementant
