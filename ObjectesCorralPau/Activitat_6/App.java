...
public class App {
    ...
    public static void introduirDadesObjecte(PasswordGenerator[] arrayContrasenya, int quantitatContrasenya) {
        for (int i = 0; i < quantitatContrasenya; i++) {
            ...
            arrayContrasenya[i] = new PasswordGenerator(longitudContrasenya);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        PasswordGenerator[] arrayContrasenya = new PasswordGenerator[quantitatContrasenya];
