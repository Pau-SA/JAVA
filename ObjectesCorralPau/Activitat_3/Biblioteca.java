...
public class Biblioteca {
    ...
    public String toString() {
        if (this.qtatLlibres == 0) {
            return ("La biblioteca " + this.nom + " està buida!");
        }else{
    ...
    public void llistatDeLlibresPerTitol() {
        for (int i = 0; i < this.prestatge.length; i++) {
            System.out.println("Llibre número " + (i + 1) + ": " + this.getPrestatge()[i].getTitol());
                                                        //aqui de l'array prestatge, mostrem tots els titols
        }
    }
    ...
    public void afegirLlibre(Llibre prestatgeRebut) {
        ...
        if (buscaLlibre(prestatgeRebut.getTitol()) == -1) {
            ...
            System.out.println("El llibre amb titol " + prestatgeRebut.getTitol() + " afegit correctament!");

        } else { // si que existeix xq és diferent de -1
            System.out.println("El llibre amb titol " + prestatgeRebut.getTitol() +" ja existeix!");
        }
    }
